...
export class SeoService {
  ...
  updateSeo(seo: SeoData): void {
    ...
    if (seo.og) {
      ...
      this.meta.updateTag({ name: 'twitter:title', content: seo.og.title || seo.meta_title });
      this.meta.updateTag({ name: 'twitter:description', content: seo.og.description || seo.meta_description });
      if (seo.og.image) {
        this.meta.updateTag({ property: 'og:image', content: seo.og.image });
        this.meta.updateTag({ name: 'twitter:image', content: seo.og.image });
