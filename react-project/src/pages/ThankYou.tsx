      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 z-0 select-none pointer-events-none">
            ...
            <div className="absolute top-1/4 -left-1/4 w-1/2 h-1/2 bg-primary/5 blur-[120px] rounded-full mix-blend-multiply" />
          ...
          >
            ...
            <motion.div
              ...
              className="space-y-2"
            >
              <span className="text-xs font-mono font-black uppercase tracking-[0.25em] text-primary block">
            ...
            >
              <Link
                to="/"
                className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary hover:bg-primary/90 text-white font-mono text-xs font-bold uppercase tracking-widest rounded-full shadow-lg shadow-primary/10 hover:shadow-primary/25 transition-all duration-300 transform active:scale-95"
              >
