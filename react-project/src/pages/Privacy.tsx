...
export function Privacy() {
  ...
  return (
    <div className="bg-white min-h-screen pb-12 selection:bg-primary selection:text-white">
      ...
      {/* 1. HERO HEADER */}
      <InternalPageHero
        title={<>Privacy & <br /> <span className="text-primary">Terms</span></>}
                  ...
                  {sections.map((section) => (
                    <li key={section.id}>
                      <button
                        ...
                        className={`text-left text-xs font-medium py-1 transition-all flex items-center gap-2 ${activeSection === section.id
                            ? 'text-primary font-bold'
                            : 'text-neutral-500 hover:text-neutral-900'
                          }`}
                      >
                        <span className={`w-1.5 h-1.5 rounded-full ${activeSection === section.id ? 'bg-primary' : 'bg-neutral-300'}`} />
                    ...
                    return (
                      <li key={sec.id} className="pl-6 relative">
                        ...
                        <button
                          ...
                          className={`text-left text-xs font-medium tracking-tight transition-all flex items-center gap-2.5 py-0.5 ${isActive
                              ? 'text-primary font-bold translate-x-1'
                              : 'text-neutral-500 hover:text-neutral-800 font-normal'
                            }`}
                        >
                          <IconComp className={`w-4 h-4 shrink-0 ${isActive ? 'text-primary' : 'text-neutral-400'}`} />
              ...
              <section id="contact" className="scroll-mt-28 space-y-6">
                ...
                <div className="space-y-3 pt-2 font-light">
                  <p className="text-sm text-neutral-600">
                    <strong className="text-neutral-900 font-bold">Email Address:</strong> <a href="mailto:privacy@maabany.com" className="text-primary hover:underline">privacy@maabany.com</a>
                  </p>
                  <p className="text-sm text-neutral-600">
