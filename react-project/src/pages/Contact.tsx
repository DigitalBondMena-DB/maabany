        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {offices.map((office) => {
            ...
            return (
              <motion.div
                key={office.id}
                className="bg-white border border-neutral-200/90 rounded-[28px] overflow-hidden shadow-xl shadow-neutral-100 flex flex-col justify-between group hover:border-primary transition-all duration-300"
                whileHover={{ y: -5 }}
              >
                ...
                <div className="p-8 space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-mono text-[10px] tracking-widest text-primary uppercase font-black">BRANCH</h3>
                  ...
                  <div className="space-y-4 pt-2">
                    ...
                    <div className="flex items-start gap-3.5 text-xs">
                      <div className="p-1.5 bg-neutral-50 rounded-lg text-neutral-500 mt-0.5 group-hover:bg-primary/10 group-hover:text-primary transition-colors shrink-0">
                    ...
                    <div className="flex items-start gap-3.5 text-xs">
                      ...
                      <div className="space-y-0.5">
                        ...
                        <a href={`mailto:${office.email}`} className="text-primary hover:underline font-medium">{office.email}</a>
                      </div>
                    </div>
                ...
                <div className="px-6 pb-6 relative shrink-0">
                  ...
                  <a
                    ...
                    referrerPolicy="no-referrer"
                    className="w-full mt-4 py-3 bg-neutral-50 hover:bg-primary/10 border border-neutral-200 hover:border-primary/30 rounded-xl text-neutral-800 hover:text-primary text-xs font-mono font-bold uppercase tracking-widest flex items-center justify-center gap-2 transition-all cursor-pointer select-none"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="space-y-4 max-w-md">
                {trustIndicators.map((indicator, idx) => (
                  ...
                  >
                    ...
                    <div className="w-10 h-10 rounded-xl bg-neutral-50 border border-neutral-150 text-primary flex items-center justify-center shrink-0 mt-0.5 transition-all duration-300 group-hover:bg-primary group-hover:text-white group-hover:border-primary group-hover:rotate-3 group-hover:scale-105 shadow-sm group-hover:shadow-primary/20">
                      {React.createElement(indicator.icon, { className: 'w-5 h-5' })}
                    </div>
                    <div>
                      <h4 className="text-xs font-bold text-neutral-950 uppercase tracking-tight group-hover:text-primary transition-colors duration-200">
                        {indicator.title}
                      </h4>
            ...
            <div className="lg:col-span-7">
              <div className="bg-white border border-neutral-200 rounded-[32px] p-8 md:p-12 shadow-2xl shadow-neutral-100 relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-44 h-44 bg-primary/5 rounded-bl-[120px] pointer-events-none" />
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        className="w-full bg-neutral-50/50 border border-neutral-200/80 p-3.5 rounded-xl text-sm focus:outline-none focus:bg-white text-neutral-800 placeholder-neutral-400 focus:border-primary focus:ring-2 focus:ring-primary/15 transition-all resize-none"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      className="w-full inline-flex items-center justify-center py-4 bg-primary hover:bg-primary/90 text-white font-mono text-xs font-bold uppercase tracking-widest rounded-xl shadow-lg shadow-primary/15 transition-all hover:-translate-y-0.5 active:translate-y-0 cursor-pointer select-none"
                    >
