    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 z-0 select-none pointer-events-none">
          ...
          <div className="absolute -bottom-20 -right-20 w-96 h-96 border border-primary/5 rounded-full animate-pulse-slow" />
        </div>
        ...
        >
          ...
          <div className="max-w-3xl space-y-4">
            ...
            <motion.div
              ...
              className="flex items-center gap-2 text-xs font-mono tracking-widest uppercase flex-wrap font-bold [&_a]:text-neutral-400 [&_a]:transition-colors hover:[&_a]:text-primary [&_span]:text-neutral-400 [&_span:last-child]:text-[#142b52] [&_span:last-child]:font-bold"
            >
              {breadcrumbs ? (
                breadcrumbs
              ) : (
